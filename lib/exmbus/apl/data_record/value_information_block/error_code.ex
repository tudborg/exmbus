defmodule Exmbus.Apl.DataRecord.ValueInformationBlock.ErrorCode do
  ...
  def decode(n) when n >= 0b1_0000 and n <= 0b1_0100, do: raise "error code #{n} not used for record errors"
  # Data errors
