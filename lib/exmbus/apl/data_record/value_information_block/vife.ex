defmodule Exmbus.Apl.DataRecord.ValueInformationBlock.Vife do
  ...
  defp exts(1, <<e::1, 0b0101100::7, rest::binary>>, opts, acc), do: exts(e, rest, opts, [{:per, :unit, :litre} | acc])
  ...
  defp exts(1, <<e::1, 0b0101111::7, rest::binary>>, opts, acc), do: exts(e, rest, opts, [{:per, :unit, :kelvin} | acc])
  ...
  defp exts(1, <<e::1, 0b0110011::7, rest::binary>>, opts, acc), do: exts(e, rest, opts, [{:per, :unit, :kelvin_litre} | acc])
  defp exts(1, <<e::1, 0b0110100::7, rest::binary>>, opts, acc), do: exts(e, rest, opts, [{:per, :unit, :volt} | acc])
  defp exts(1, <<e::1, 0b0110101::7, rest::binary>>, opts, acc), do: exts(e, rest, opts, [{:per, :unit, :ampere} | acc])
