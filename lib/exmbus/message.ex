defmodule Exmbus.Message do
  ...
  def from_layers(layers, opts) when is_list(opts),
    do: from_layers(layers, opts |> Enum.into(%{}))
  ...
  def from_layers(layers, opts) when is_map(opts) do
    ...
    layers =
      case Map.get(opts, :keep_layers, false) do
        true -> layers
        false -> nil
      end
