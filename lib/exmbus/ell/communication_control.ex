defmodule Exmbus.Ell.CommunicationControl do
  defstruct [
    bidirectional: nil,
    response_delay: nil,
    synchronized: nil,
    hop_count: nil,
    priority: nil, # true for alarms and other critical data.
    accessibility: nil,
    repeated_access: nil,
  ]
  ...
  def decode(<<b::1, d::1, s::1, h::1, p::1, a::1, r::1, x::1>>) do
    ...
    {:ok,
      %__MODULE__{
        ...
        synchronized: s == 1, # according to 12.6.2
        hop_count: h == 1,
        priority: p == 1, # true for alarms and other critical data.
        accessibility: a == 1,
        repeated_access: r == 1,
      }}
  end
