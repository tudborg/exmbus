      ...
      assert [
              ...
              %Exmbus.Tpl{
                ...
                header: %Exmbus.Tpl.Long{
                  access_no: 161,
                  configuration_field: %Exmbus.Tpl.ConfigurationField{accessibility: false, bidirectional: false, blocks: nil, content_of_message: 0, hop_count: 0, mode: 0, repeater_access: 0, syncrony: false},
                  status: %Exmbus.Tpl.Status{application_status: :no_error, low_power: false, manufacturer_status: 1, permanent_error: false, temporary_error: false},
                  device: :electricity,
